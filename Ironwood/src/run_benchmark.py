...
COMPUTE_BENCHMARK_MAP = {
    ...
    "rem": "benchmark_compute.rem",
    "pow": "benchmark_compute.pow",
    "maximum": "benchmark_compute.maximum",
    "minimum": "benchmark_compute.minimum",
    "atan2": "benchmark_compute.atan2",
    "nextafter": "benchmark_compute.nextafter",
    "binary_op": "benchmark_compute.binary_op",
